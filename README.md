...
This plugin contains additional checks for checkstyle. It is packaged as an eclipse plugin, so it can be used with the [Eclipse Checkstyle Plugin](http://eclipse-cs.sourceforge.net) by just putting the [invesdwin-checkstyle-plugin.jar](http://invesdwin.de/artifactory/invesdwin-oss/de/invesdwin/invesdwin-checkstyle-plugin/1.0.3/invesdwin-checkstyle-plugin-1.0.3.jar) inside `eclipse/dropins/`.
