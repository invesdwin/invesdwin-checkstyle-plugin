...
public final class AnnotationUtility {
	 ...
	 *
	 * <p>
	 * This method will not look for imports or package statements to detect the
	 * passed in annotation.
	 * </p>
	 *
	 * <p>
	 * To check if an AST contains a passed in annotation taking into account
	 * fully-qualified names (ex: java.lang.Override, Override) this method will
	 * need to be called twice. Once for each name given.
	 * </p>
	 *
	 ...
	 */
	public static boolean containsAnnotation(final DetailAST ast, String annotation) {
		if (ast == null) {
	...
	/**
	 * Gets the AST that holds a series of annotations for the potentially annotated
	 * AST. Returns {@code null} the passed in AST is not have an Annotation Holder.
	 *
	 * @param ast the current node
